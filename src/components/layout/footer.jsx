...
export const Footer = () => {
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-white" style={{ backgroundColor: "#0d9486" }}>
      {/* Top Section */}
