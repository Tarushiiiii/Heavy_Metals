...
import { GoogleMap, HeatmapLayer, Circle, InfoWindow, useJsApiLoader } from '@react-google-maps/api';
            ...
            {hovered && (
                ...
                >
                    <div>
                        ...
                        <span style={{ fontWeight: 'bold' }}>{hovered.hmpi}</span>
                        <br />
                        <strong>
                            Risk:
                        </strong>
                        <span style={{ color: statusColors[hovered.status], fontWeight: 'bold', padding: '2px' }}>
                            {hovered.status}
                        </span>
                    </div>
                </InfoWindow>
