export const Button = ({
  ...
  const variants = {
    ...
    secondary:
      "bg-[white] border-2 border-[#0c7d72] text-gray-800 hover:bg-[#0c7d72] hover:text-white transition-colors duration-200 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed",
    "secondary-blue":
